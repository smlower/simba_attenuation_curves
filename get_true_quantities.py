...
file_ = pd.read_json('/orange/narayanan/s.lower/simba/galaxy_properties/attenuation_curves/simba_m25_z0_attenuation_curves.json')
...
ds = yt.load('/orange/narayanan/s.lower/simba/desika_filtered_snaps/snap305/galaxy_'+str(galaxy)+'.hdf5')
ad = ds.all_data()
